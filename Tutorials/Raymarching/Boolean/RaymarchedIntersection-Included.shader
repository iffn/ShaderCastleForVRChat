Shader "ShaderCastle/Tutorials/Raymarching/Boolean/RaymarchedIntersection-Included"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float booleanIntersection(float a, float b)
			{
				return max(a, b);
			}
			...
			float mainSDF(float3 p)
			{
				...
				return booleanIntersection(sphere1, sphere2);
			}
