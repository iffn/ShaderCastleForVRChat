    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target {
                ...
                half3 BRDFLightFactor = microfacetBRDF(worldNormal, viewVector, lightVector, NdotV, NdotL, albedo.rgb, roughness, metallic, _reflectance);
                ...
                float3 indirectFresnel = FresnelReflectionWithSchlickApproximation(NdotV, _reflectance, albedo, metallic);
